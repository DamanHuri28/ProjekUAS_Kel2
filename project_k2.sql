...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jan 2024 pada 18.22
...
(50, 'Kel2', '$2y$10$D2iEa8J0HsEsc/nbfuvxYuGb.ZlHXDCKUFsJXp4vqGq/I0LIll/aS', 'kelompok2', 'Member'),
(53, 'member', '$2y$10$ZYgXulVONDkyIOlokX14s.f19xY8YTmNwOCpGNQqypz6dawPmzBC2', 'RUBERT DONEY', 'Member'),
(54, 'kel2', '$2y$10$7vE9Ak1Lv3lUj3hpmsp/sOYjonE/Cf3Um4gnGSazqKrvJAso4oWpO', 'kel2', 'Admin'),
(55, 'refito', '$2y$10$0DrUSzKohWJ8KLSamuOLRejcDkCUN.tab5GSGdonb5i.Dh/YXc8Hm', 'fito', 'Member'),
(56, 'daman', '$2y$10$dvcIp9K25Z0VjxfU7jco3.dqAOne5Jy94WyMr6RuV3lPz/V4F3XTu', 'daman huri', 'Admin'),
(57, 'nana', '$2y$10$i/KzwoH3LLRWZ.arCI1S4.Yi4pl5dJdKBh485i.Rl8e8JXxbgKQqe', '1', 'Member');
...
--
-- Dumping data untuk tabel `pengingat_pembayaran`
--

INSERT INTO `pengingat_pembayaran` (`reminder_id`, `user_id`, `deskripsi`, `tanggal_jatuh_tempo`, `status_pembayaran`) VALUES
(5, 42, 'Bantuan Kemanusiaan Palestina', '2023-01-17', 'Dibayar'),
(6, 30, 'Bantuan Dana Sosial Sudiarjo', '2023-07-19', 'Belum Dibayar'),
(9, 4, 'Iuran Success Banjir Riau', '2023-01-18', 'Belum Dibayar'),
(10, 12, 'Dana Sosial Dana Bos', '2023-09-27', 'Dibayar'),
(11, 43, 'Dana Sosial Dana Bos', '2023-01-26', 'Dibayar'),
(12, 1, 'Iuran Success Banjir Riau', '2023-01-31', 'Belum Dibayar'),
(13, 56, 'Dana Sosial Dana Bos', '2024-01-22', 'Belum Dibayar'),
(14, 55, 'Iuran Success Banjir Riau', '2024-01-08', 'Belum Dibayar'),
(15, 55, 'Bantuan Dana Kasih', '2024-01-09', 'Belum Dibayar'),
(16, 55, 'Dana Bos Bersama', '2024-01-05', 'Belum Dibayar');
...
INSERT INTO `transaksi` (`transaksi_id`, `user_id`, `deskripsi`, `tipe`, `jumlah`, `tanggal_transaksi`) VALUES
(3, 55, 'Dana Sosial Dana Bos', 'pemasukan', 220000, '2024-01-08');
...
--
ALTER TABLE `pengguna`
  MODIFY `user_Id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT untuk tabel `pengingat_pembayaran`
--
ALTER TABLE `pengingat_pembayaran`
  MODIFY `reminder_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `transaksi`
--
ALTER TABLE `transaksi`
  MODIFY `transaksi_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
