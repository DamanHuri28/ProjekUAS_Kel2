        ...
        <div class="card bg-gradient-danger card-img-holder text-white">
          <div class="card-body">
            <img src="<?= base_url('assets/') ?>/images/dashboard/circle.svg" class="card-img-absolute"
              alt="circle-image" />
            <h4 class="font-weight-normal mb-3">Total Iuran <i class="mdi mdi-chart-line mdi-24px float-right"></i>
            </h4>
            <h2 class="mb-5">4.563.200</h2>
